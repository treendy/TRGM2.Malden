...
fnc_CustomMission = { //This function is the main script for your mission, some if the parameters passed in must not be changed!!!
	...
	*/
	...
	[_objRadio1, [localize "STR_TRGM2_startInfMission_MissionTitle6_Button", {_this spawn TREND_fnc_downloadData;}, [localize "STR_TRGM2_downloadData_title", true, "TREND_fnc_bugRadio1", []], 0, true, true, "", "_this isEqualTo player"]] remoteExec ["addAction", 0, true];
