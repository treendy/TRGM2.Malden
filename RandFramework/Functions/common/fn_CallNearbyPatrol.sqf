...
_MainObjectivePos = TREND_ObjectivePossitions select _iTaskIndex;
if (isNil "_MainObjectivePos") then {_MainObjectivePos = TREND_ObjectivePossitions select 0;};

format["Spotted: %1", _thisThisList] call TREND_fnc_log;
