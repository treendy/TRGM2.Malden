...
TREND_AllFactionData = TREND_WestFactionData + TREND_EastFactionData + TREND_GuerFactionData;
TREND_AllFactionData = [TREND_AllFactionData, [], { _x select 1 }, "ASCEND"] call BIS_fnc_sortBy;
publicVariable "TREND_AllFactionData";
