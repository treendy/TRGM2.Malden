...
if (isServer) then {
    ...
    if (!TRGM_VAR_AOCampOnlyAmmoBox) then {
        if (!_bAOStartRoadFound) then {
            ...
            _flatPosTent1 = nil;
            _flatPosTent1 = [_flatPosCampFire , 5, 10, 5, 0, 0.5, 0,[],[_behindBlockPos,_behindBlockPos],"Land_TentA_F"] call TRGM_GLOBAL_fnc_findSafePos;
            _Tent1 = "Land_TentA_F" createVehicle _flatPosTent1;
            _Tent1 setDir (floor(random 360));

            _flatPos2 = nil;
            _flatPos2 = [_flatPosCampFire , 5, 10, 5, 0, 0.5, 0,[],[_behindBlockPos,_behindBlockPos],"Land_TentA_F"] call TRGM_GLOBAL_fnc_findSafePos;
            ...
            _flatPos4 = nil;
            _flatPos4 = [_flatPosCampFire , 5, 10, 5, 0, 0.5, 0,[],[_behindBlockPos,_behindBlockPos],"Land_WoodPile_F"] call TRGM_GLOBAL_fnc_findSafePos;
        ...
        _flatPos5 = nil;
        _flatPos5 = [_flatPosCampFire, 12, 30, 12, 0, 0.5, 0,[],[[0,0,0],[0,0,0]],selectRandom (call FriendlyFastResponseVehicles)] call TRGM_GLOBAL_fnc_findSafePos;
        ...
        _flatPos6 = nil;
        _flatPos6 = [_flatPosCampFire, 12, 30, 12, 0, 0.5, 0,[],[[0,0,0],[0,0,0]],selectRandom (call FriendlyFastResponseVehicles)] call TRGM_GLOBAL_fnc_findSafePos;
    ...
    _flatPos7 = nil;
    _flatPos7 = [_flatPosCampFire, 5, 12, 5, 0, 0.5, 0,[],[_behindBlockPos,_behindBlockPos],"C_T_supplyCrate_F"] call TRGM_GLOBAL_fnc_findSafePos;
