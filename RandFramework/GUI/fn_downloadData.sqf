/*
[OBJECT, ["DOWNLOAD DATA", { _this spawn TREND_fnc_downloadData; }, ["Downloading data from terminal...", "FUNCTION", true, ["This is an array of arguments for the callback!"]], 0, true, true, "", "_this == player"]] remoteExec ["addAction", 0, true];
*/
